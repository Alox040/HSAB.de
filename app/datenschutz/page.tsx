  ...
  return (
    <>
      <PageIntro
        ...
        description="Hinweise zur Verarbeitung personenbezogener Daten auf dieser Website und bei Kontaktanfragen."
      />
        ...
        <ContentContainer>
          <article className="surface-card mx-auto flex max-w-3xl flex-col gap-8 p-6 sm:p-8">
            <div className="flex flex-wrap gap-3 text-sm text-[var(--text-muted)]">
              <Link href="/impressum" className="hover:text-[var(--primary)] hover:underline">
                Zum Impressum
              </Link>
            </div>
