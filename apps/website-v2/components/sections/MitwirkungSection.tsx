...
export default function MitwirkungSection(): React.JSX.Element {
  const content = site.mitwirkung;
      ...
      <Container>
        <div className="space-y-4 rounded-2xl border border-slate-200 p-6 sm:p-8">
          ...
          <a
            ...
            className="inline-flex min-h-12 items-center rounded-lg border border-slate-300 px-5 text-lg font-medium text-slate-900"
          >
            {content.ctaLabel}
          </a>
        </div>
